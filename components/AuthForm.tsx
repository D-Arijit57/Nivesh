...
import CustomInput, { convertToAPIFormat } from './CustomInput';
    ...
    const onSubmit = async (data: z.infer<typeof formSchema>) => {
      ...
      try {
        ...
        if(type === 'sign-up') {
          ...
          const apiDateOfBirth = convertToAPIFormat(data.dateOfBirth!);
          
          // Get phone number (remove formatting, keep +91 prefix as digits)
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              {type === 'sign-up' && (
                <>
                  ...
                  <CustomInput control={form.control} name='phone' label="Phone Number" placeholder='+91 XXXXX XXXXX' />
                </>
              )}
